...
//		return new ExcelDataProvider().getTestDataByExcel("D:\\AD\\temp\\ITAuto.xlsx", "Sheet1");
//		
//	}
	
//	@DataProvider(name="autojdbclogin")
//	public Object[][] getDatabaseData1(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'login'");
//	}
//	
//	
//	@DataProvider(name="autojdbcqueryuser")
//	public Object[][] getDatabaseData2(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'user query'");
//	}
//	
//	@DataProvider(name="autojdbcqueryrole")
//	public Object[][] getDatabaseData3(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'role query'");
//	}
//	
//	@DataProvider(name="autojdbcquerypermission")
//	public Object[][] getDatabaseData4(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'permission query'");
//	}
//	
//	
//	@DataProvider(name="autojdbcaddrole")
//	public Object[][] getDatabaseData5(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'add role'");
//	}
//	
//	
//	@DataProvider(name="autojdbcaddpermission")
//	public Object[][] getDatabaseData6(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'add permission'");
//	}
//	
//	
//	@DataProvider(name="autojdbcedituser")
//	public Object[][] getDatabaseData7(){
//		return new MysqlDataProvider().getTestDataByMysql("select * from `managetest` where module = 'edit user'");
//	}
